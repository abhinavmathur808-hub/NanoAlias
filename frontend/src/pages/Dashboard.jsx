...
export default function Dashboard() {
    ...
    const toggleShare = (id) => setOpenShareId((prev) => (prev === id ? null : id));
    ...
    // Social share dropdown renderer
    const renderShareMenu = (url) => {
        ...
        return (
            <div
                className="absolute left-0 top-full mt-2 z-50 w-52 rounded-xl shadow-2xl py-1.5 animate-in fade-in slide-in-from-top-2"
                                            ...
                                            >
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="relative" ref={openShareId === url._id ? shareRef : null}>
                                                            <button
                                                                onClick={() => toggleShare(url._id)}
